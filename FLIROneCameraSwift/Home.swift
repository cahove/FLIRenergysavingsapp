...
// Image Variable
struct GVariables {
    static var thermalImage: Image = Image("")
}
    
struct Home: View {
    
    
    init() // runs when starts
    {
        ...
        ZStack
        {
            Color("LightGray")
                ...
                VStack
                {
                    ...
                    // Connect button
                    // Navigation Link for connect button
                    NavigationLink(destination: CameraViewer(), label: {
                        HStack {
                            Label("Connect Device", systemImage: "cable.connector.horizontal")
                            .frame(width: 350, height: 90)
            ...
            .navigationTitle("Roof Inspection")
...
// MARK: Camera Viewer Video Formats
...
// Updates image file
class Imaging {
    static func selectImg(image: Image) {
        GVariables.thermalImage = image
        CameraViewer()
...
class ViewController: UIViewController {
   ...
   // @IBOutlet weak var imageView: UIImageView!
    ...
    // MARK: Function events
     func connectDeviceClicked(_ sender: Any) {
    ...
    @IBAction func disconnectClicked(_ sender: Any) {
      ...
      func connectEmulator(_ sender: Any) {
